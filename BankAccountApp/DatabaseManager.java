...
public class DatabaseManager {
    ...
    public DatabaseManager() {
        try {
            ...
            // Create connection URL using forward slashes
            ...
            System.err.println("  1. Database file is open in MS Access - CLOSE IT!");
            System.err.println("  2. Database file is corrupted");
    ...
    public void saveAccount(Account account) throws SQLException {
        ...
        String sql = "INSERT INTO Accounts (AccountNumber, FirstName, LastName, NIN, " +
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            pstmt.setDate(7, Date.valueOf(account.getDateOfBirth()));
            pstmt.setString(8, account.getAccountType());
            pstmt.setString(9, account.getBranch());
            pstmt.setDouble(10, account.getOpeningDeposit());
            pstmt.setString(11, account.getPin());
            pstmt.setDate(12, Date.valueOf(java.time.LocalDate.now()));
