...
public class JointAccount extends Account {
    ...
    // Updated Constructor to accept secondNIN directly
    public JointAccount(String firstName, String lastName, String nin, String secondNIN, String email,
        ...
        this.secondNIN = secondNIN; // Assigns the field immediately at creation
    }
    ...
    // Recommended: Override toString() to display both holders to the lecturer
    @Override
    public String toString() {
        return super.toString() + "\nCo-Applicant NIN: " + secondNIN;
    }
}